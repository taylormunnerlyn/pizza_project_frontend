...
git fetch es6
git cherry-pick f3dfe6e..es6/master
git remote remove es6
```
The commit hash `f3dfe6e` is the first stable commit. If you have used a more recent version, you may have to use a newer commit hash.
